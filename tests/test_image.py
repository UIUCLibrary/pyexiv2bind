...
def test_invalid_file(sample_images_readonly):
    bad_file = os.path.join(sample_images_readonly, "not_a_real_file.jp2")
    with pytest.raises(FileNotFoundError):
        my_image = Image(bad_file)


def test_image2_filename(sample_images_readonly):
    sample_file = os.path.join(sample_images_readonly, "dummy.jp2")
    my_image = Image(sample_file)
    assert my_image.filename == sample_file


def test_image2_pixelHeight(sample_images_readonly):
    sample_file = os.path.join(sample_images_readonly, "dummy.jp2")
    my_image = Image(sample_file)
...
def test_image2_pixelWidth(sample_images_readonly):
    sample_file = os.path.join(sample_images_readonly, "dummy.jp2")
    my_image = Image(sample_file)
...
def test_image2_exif(sample_images_readonly):
    sample_file = os.path.join(sample_images_readonly, "dummy.jp2")
    my_image = Image(sample_file)
...
def test_image2_iptc(sample_images_readonly):
    sample_file = os.path.join(sample_images_readonly, "dummy.jp2")
    my_image = Image(sample_file)
...
def test_image_get_icc_data(sample_images_readonly):
    sample_file = os.path.join(sample_images_readonly, "dummy.tif")
    my_image = Image(sample_file)
